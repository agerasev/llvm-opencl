...
define dso_local spir_kernel void @kernel_main(
  ...
  %select_c = trunc <4 x i8> %a to <4 x i1>
  %select = select <4 x i1> %select_c, <4 x i8> %b, <4 x i8> %c
  %select_p = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %30, i32 %i
  store <4 x i8> %select, <4 x i8> addrspace(1)* %select_p, align 4
