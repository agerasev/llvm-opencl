...
define dso_local spir_kernel void @kernel_main(
  ...
  ;%select_c = trunc i1 %a to i1
  %select = select i1 %a, i1 %b, i1 %c
  %select_x = zext i1 %select to i8
