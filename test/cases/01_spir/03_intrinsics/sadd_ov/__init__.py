...
class Tester(BaseTester):
    def __init__(self, *args):
        ...
        self.a = np.array([0, -1, -1, (1<<31)-1, (1<<31), 1<<30, -(1<<30), (1<<31)-1], dtype=cltypes.uint)
        self.b = np.array([0, 1, -1, (1<<31)-1, (1<<31), 1<<30, -(1<<30), 1<<31], dtype=cltypes.uint)
        self.c = self.a + self.b
        self.o = np.array([0, 0, 0, 1, 1, 1, 0, 0], dtype=cltypes.uchar)
        self.n = len(self.a)
