...
class Tester(BaseTester):
    def __init__(self, *args):
        ...
        self.a = np.array([0, 0, -1,  0,         0,     0, 1<<30], dtype=cltypes.uint)
        self.b = np.array([0, 1, -1, -1, (1<<31)-1, 1<<31, 3<<30], dtype=cltypes.uint)
        self.o = np.array([0, 0,  0,  0,         0,     1,     1], dtype=cltypes.uchar)
