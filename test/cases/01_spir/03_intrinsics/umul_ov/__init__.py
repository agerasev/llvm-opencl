...
class Tester(BaseTester):
    def __init__(self, *args):
        ...
        self.a = np.array([0, -1, -1, 1<<15, 1<<15, 1<<15, -(1<<31), -(1<<31)], dtype=cltypes.uint)
        self.b = np.array([0, 1, -1, 1<<15, 1<<16, -1<<16, 1, -1], dtype=cltypes.uint)
        self.c = self.a*self.b
        self.o = np.array([0, 0, 0, 0, 1, 0, 0, 1], dtype=cltypes.uchar)
        self.n = len(self.a)
